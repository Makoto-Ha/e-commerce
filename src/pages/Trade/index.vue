  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="(address, index) in addressInfo" :key="address.id">
        <span @click="changeDefault(address, addressInfo)" class="username" :class="{selected: address.isDefault === '1'}">{{ address.consignee }}</span>
  ...
  export default {
    ...
    methods: {
      changeDefault(address, addressInfo) {
        addressInfo.forEach(address => address.isDefault = '0');
        address.isDefault = '1';
      },
      async submitOrder() {
        ...
        let response = await this.$API.reqSubmitOrder(tradeNo, data);
        if(response.ok) {
