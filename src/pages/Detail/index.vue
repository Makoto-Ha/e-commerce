      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" @change="changeSkuNum" :value="skuNum">
...
<script>
  ...
  export default {
    ...
    methods: {
      changeActive(target, lists) {
        lists.forEach(item => item.isChecked = '0');
        target.isChecked = '1';
      },
      changeSkuNum(e) {
